...
public class Mon1 extends AppCompatActivity {
    ...
    private String TAG = Mon1.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Mon1.GetContacts("http://192.168.43.202/R.php?username=" + session.getUsername()).execute();

        showPopupBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //instantiate the popup.xml layout file
                LayoutInflater layoutInflater = (LayoutInflater) Mon1.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Mon1.this);
        ...
        protected void onPostExecute(Void result) {
             ...
             * */
            ListAdapter adapter = new SimpleAdapter(Mon1.this, contactList,
                    R.layout.list_item2, new String[]{"9", "10", "11", "2", "1", "12", "3", "4"
