...
public class Fri1 extends AppCompatActivity {
    ...
    private String TAG = Fri1.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Fri1.GetContacts("http://192.168.43.202/R.php?username=" + session.getUsername()).execute();

        showPopupBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //instantiate the popup.xml layout file
                LayoutInflater layoutInflater = (LayoutInflater) Fri1.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Fri1.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (jsonStr != null) {
                try {
                    ...
                    for (int i = 8; i < contacts.length(); i++) {
        ...
        protected void onPostExecute(Void result) {
             ...
             * */
            ListAdapter adapter = new SimpleAdapter(Fri1.this, contactList,
