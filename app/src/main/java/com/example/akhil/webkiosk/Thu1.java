...
public class Thu1 extends AppCompatActivity {
    ...
    private String TAG = Thu1.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Thu1.GetContacts("http://192.168.43.202/R.php?username=" + session.getUsername()).execute();

        showPopupBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //instantiate the popup.xml layout file
                LayoutInflater layoutInflater = (LayoutInflater) Thu1.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Thu1.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (jsonStr != null) {
                try {
                    ...
                    for (int i = 6; i < contacts.length(); i++) {
...
;
        ...
        protected void onPostExecute(Void result) {
             ...
             * */
            ListAdapter adapter = new SimpleAdapter(Thu1.this, contactList,
