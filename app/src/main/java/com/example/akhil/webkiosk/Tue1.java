...
public class Tue1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Tue1.GetContacts("http://192.168.43.202/R.php?username=" + session.getUsername()).execute();

        showPopupBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //instantiate the popup.xml layout file
                LayoutInflater layoutInflater = (LayoutInflater) Tue1.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Tue1.this);
        ...
        protected void onPostExecute(Void result) {
             ...
             * */
            ListAdapter adapter = new SimpleAdapter(Tue1.this, contactList,
