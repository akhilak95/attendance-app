...
public class Wed1 extends AppCompatActivity {
    ...
    private String TAG = Wed1.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Wed1.GetContacts("http://192.168.43.202/R.php?username=" + session.getUsername()).execute();

        showPopupBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //instantiate the popup.xml layout file
                LayoutInflater layoutInflater = (LayoutInflater) Wed1.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Wed1.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (jsonStr != null) {
                try {
                    ...
                    for (int i = 4; i < contacts.length(); i++) {
        ...
        protected void onPostExecute(Void result) {
             ...
             * */
            ListAdapter adapter = new SimpleAdapter(Wed1.this, contactList,
